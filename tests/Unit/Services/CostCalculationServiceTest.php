...
it('calculates cost using default prices', function (): void {
...
it('calculates cost for zero tokens', function (): void {
    $service = new CostCalculationService;
...
it('calculates cost with only input tokens', function (): void {
    $service = new CostCalculationService;
...
it('calculates cost with only output tokens', function (): void {
    $service = new CostCalculationService;
...
it('calculates cost with custom prices', function (): void {
    $service = new CostCalculationService(
...
it('rounds cost to 6 decimal places', function (): void {
    $service = new CostCalculationService;
...
it('rounds to 6 decimals for non-exact results', function (): void {
    $service = new CostCalculationService;
...
it('treats null tokens as zero', function (): void {
    $service = new CostCalculationService;
...
it('handles mixed null and valid tokens', function (): void {
    $service = new CostCalculationService;
