...
it('streams an AI response as SSE for a valid message', function () {
...
it('includes all SSE event types in the stream', function () {
...
it('sends the user prompt to the agent', function () {
