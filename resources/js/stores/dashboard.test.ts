...
describe('dashboard store', () => {
    ...
    describe('fetchActivity', () => {
        it('fetches activity from API and sets feed', async () => {
            ...
            expect(mockedAxios.get).toHaveBeenCalledWith('/api/v1/activity', { params: { per_page: 25 } });
            expect(store.activityFeed).toHaveLength(1);
        ...
        it('sets isLoading during fetch', async () => {
            ...
            mockedAxios.get.mockReturnValueOnce(new Promise((resolve) => {
    ...
    describe('fetchPMActivity', () => {
        it('fetches PM activity from API', async () => {
            ...
            expect(mockedAxios.get).toHaveBeenCalledWith('/api/v1/dashboard/pm-activity');
