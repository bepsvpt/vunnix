...
- `docs/audits/architecture/2026-02-19.md` (staff audit proposal)
- `docs/extensions/ext-019-x3-iteration-development-architecture.md` (initial migration plan)
- `docs/extensions/ext-020-x3-iteration-architecture-closure.md` (closure plan for remaining gaps)
