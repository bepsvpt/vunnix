...
### Architecture Fit
- **Components affected:** `eslint.config.js` (new), `package.json` (modify), `.claude/settings.json` (modify — add hook alongside Pint), `.claude/hooks/run-eslint.sh` (new), `.github/workflows/tests.yml` (modify), `CLAUDE.md` (modify), `docs/reference/spec/decisions-index.md` (modify)
...
**Verification:** `grep -c 'D18[012]' docs/reference/spec/decisions-index.md` returns 3.
