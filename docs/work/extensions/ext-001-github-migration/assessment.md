...
| `docs/guides/project-setup.md` | Setup instructions rewritten for GHCR + remote include | 1 |
| `app/Services/ProjectEnablementService.php` | Visibility warning (line 74) no longer applies | 1 |
| `docs/reference/spec/decisions-index.md` | D65 superseded, D150 modified, new decisions added | 1 |
