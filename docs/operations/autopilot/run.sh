...
# is disabled. State lives in docs/operations/autopilot/progress.md, not conversation.
#
# Usage:
...
#   bash docs/operations/autopilot/watch_progress.sh    Progress dashboard
#   tail -f docs/operations/autopilot/logs/runner.log   Runner log
# ============================================================
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "  bash docs/operations/autopilot/watch_progress.sh    Progress dashboard"
            echo "  tail -f docs/operations/autopilot/logs/runner.log   Runner log"
            exit 0 ;;
        *)
